...
export const getUserPurchasesThunk = () => dispatch => {
    ...
    axios
        .get("https://e-comerce-backend-diego-ortiz.onrender.com/api/v1/purchases", getConfig())
	.then(res => dispatch(setUserPurchases(res.data.purchases)))
...
export const addUserPurchaseThunk = purchase => dispatch => {
    ...
    axios
        .post(
	    "https://e-comerce-backend-diego-ortiz.onrender.com/api/v1/purchases",
	    {
